...
import { formatDate } from "@/utils/funtion/slipFuntion";
...
const ListInventory = () => {
  ...
  const handleClickPen = (recordInventoryId) => {
    navitate(`/infor-inventory/${recordInventoryId}`);
  };
    ...
    <>
      ...
      <div className="container_ListInventory">
        ...
        <div
          ...
          onClick={() => navitate("/created-inventory")}
        >
